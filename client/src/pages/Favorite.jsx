...
const Favorite = () => {
    ...
    return (
        <div className=" h-screen w-screen overflow-y-auto flex flex-col items-center overflow-x-hidden">
            ...
            <div className="m-5  gap-4 px-5 relative h-50 w-full flex flex-wrap">
